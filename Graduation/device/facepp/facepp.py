...
from device.facepp.structures import ObjectDict
from device.facepp.compat import (basestring, str, numeric_types, enc, choose_boundary,
...
API_KEY = "hgVVRhOG0JK5nZLnq0md-TeUven0A1Xv"
API_SECRET = "LkVIV340Nlh9WTf6jvnMNLTHsaiArrzl"
